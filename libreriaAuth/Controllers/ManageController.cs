...
namespace autentifAuthorized.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        {
            ListPaginator<Factura> paginator = new ListPaginator<Factura>(0, 0, 8);
            var model = new CarritoRepository().findFacturasUsuario(HttpContext.User.Identity.GetUserId());
            paginator.SetPaginatedList(pagina, model);
